...
11. **`docs/commit-standard.md`** — Especificaciones y formato obligatorio para los mensajes de commit.
...
15. **`scripts/`**
    ...
    - `docs/commands.md` — COmandos para poder generar un archivo en la carpeta .changes/ y compilarlo en el CHANGELOG.md principal
    ...
    repos:
        ...
        - repo: https://github.com/pre-commit/mirrors-prettier
          ...
          hooks:
              - id: prettier
                types_or:
                    [javascript, typescript, jsx, tsx, json, yaml, markdown]
